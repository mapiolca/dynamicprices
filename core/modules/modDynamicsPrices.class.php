...
/* BEGIN MODULEBUILDER DICTIONARIES */
		$this->dictionaries = array(
			...
			'tabsql' => array(
				'SELECT t.rowid as rowid, t.entity, t.code, COALESCE(t.fk_commercial_category, t.fk_nature) as fk_commercial_category, cc.label as commercial_category_label, t.pricelevel, t.minrate, t.targetrate, t.active FROM '.MAIN_DB_PREFIX.'c_coefprice AS t LEFT JOIN '.MAIN_DB_PREFIX.'c_commercial_category as cc ON cc.rowid = COALESCE(t.fk_commercial_category, t.fk_nature) WHERE t.entity = '.((int) $conf->entity),
				'SELECT t.rowid as rowid, t.entity, t.code, COALESCE(t.fk_commercial_category, t.code_nature) as fk_commercial_category, cc.label as commercial_category_label, t.margin_on_cost_percent, t.active FROM '.MAIN_DB_PREFIX.'c_margin_on_cost AS t LEFT JOIN '.MAIN_DB_PREFIX.'c_commercial_category as cc ON cc.rowid = COALESCE(t.fk_commercial_category, t.code_nature) WHERE t.entity = '.((int) $conf->entity),
