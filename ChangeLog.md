...
- Limitation de l'application automatique du prix de revient à la création des lignes commerciales afin de préserver le coût déjà sélectionné lors de l'édition. / Limited automatic cost price application to commercial line creation to preserve the already selected cost during line editing.
