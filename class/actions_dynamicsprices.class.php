...
class ActionsDynamicsPrices extends CommonHookActions
{
	...
	public function formConfirm($parameters, &$object, &$action, $hookmanager)
	{
		...
		$html .= '<table class="noborder dynamicsprices-modal-table">';
		$html .= '<tr class="liste_titre">';
		$html .= '<td class="dynamicsprices-modal-col">&nbsp;</td>';
		$html .= '<td class="dynamicsprices-modal-col">'.$langs->trans('ProductRef').'</td>';
		$html .= '<td class="dynamicsprices-modal-col">'.$langs->trans('LMDB_SupplierRef').'</td>';
		$html .= '<td class="right dynamicsprices-modal-col">'.$langs->trans('QtyMin').'</td>';
		$html .= '<td class="right dynamicsprices-modal-col">'.$langs->trans('LMDB_QuantityPackaging').'</td>';
		$html .= '<td class="right dynamicsprices-modal-col">'.$langs->trans('VATRate').'</td>';
		$html .= '<td class="right dynamicsprices-modal-col">'.$langs->trans('LMDB_CurrentUnitPriceHT').'</td>';
		$html .= '<td class="right dynamicsprices-modal-col">'.$langs->trans('LMDB_ProposedUnitPriceHT').'</td>';
		$html .= '<td class="right dynamicsprices-modal-col">'.$langs->trans('LMDB_PriceDeltaHT').'</td>';
		$html .= '<td class="center dynamicsprices-modal-col">'.$langs->trans('LMDB_PriceDirection').'</td>';
		$html .= '<td class="right dynamicsprices-modal-col">'.$langs->trans('Discount').' (%)</td>';
		$html .= '</tr>';

		foreach ($displayDifferences as $lineId => $diff) {
			$html .= '<tr class="oddeven">';
			$html .= '<td class="dynamicsprices-modal-col"><input type="checkbox" name="dynamicsprices_apply_line['.$lineId.']" value="1" checked></td>';
			$html .= '<td class="dynamicsprices-modal-col">'.$this->getProductNomUrl((int) $diff['fk_product'], $diff['ref']).'</td>';
			$html .= '<td class="dynamicsprices-modal-col"><input class="dynamicsprices-modal-input" type="text" name="dynamicsprices_data['.$lineId.'][supplier_ref]" value="'.dol_escape_htmltag($diff['supplier_ref']).'"></td>';
			$html .= '<td class="right dynamicsprices-modal-col"><input class="right dynamicsprices-modal-input" type="text" name="dynamicsprices_data['.$lineId.'][qty]" value="'.dol_escape_htmltag((string) $diff['qty']).'"></td>';
			$html .= '<td class="right dynamicsprices-modal-col"><input class="right dynamicsprices-modal-input" type="text" name="dynamicsprices_data['.$lineId.'][unitquantity]" value="'.dol_escape_htmltag((string) $diff['unitquantity']).'"></td>';
			$html .= '<td class="right dynamicsprices-modal-col"><input class="right dynamicsprices-modal-input" type="text" name="dynamicsprices_data['.$lineId.'][vat]" value="'.dol_escape_htmltag((string) $diff['vat']).'"></td>';
			$html .= '<td class="right dynamicsprices-modal-col">'.dol_escape_htmltag((string) $diff['current_unitprice']).'</td>';
			$html .= '<td class="right dynamicsprices-modal-col"><input class="right dynamicsprices-modal-input" type="text" name="dynamicsprices_data['.$lineId.'][unitprice]" value="'.dol_escape_htmltag((string) $diff['new_unitprice']).'"></td>';
			$html .= '<td class="right dynamicsprices-modal-col">'.dol_escape_htmltag($this->getPriceDeltaLabel($diff)).'</td>';
			$html .= '<td class="center dynamicsprices-modal-col">'.$this->getPriceDirectionBadgeHtml($diff['price_direction']).'</td>';
			$html .= '<td class="right dynamicsprices-modal-col"><input class="right dynamicsprices-modal-input" type="text" name="dynamicsprices_data['.$lineId.'][discount]" value="'.dol_escape_htmltag((string) $diff['discount']).'" placeholder="%"></td>';
		...
		$this->resprints .= '$dialog.find(".dynamicsprices-modal-col").css({"max-width":"40px","width":"40px","overflow":"hidden","text-overflow":"ellipsis","white-space":"nowrap"});';
		$this->resprints .= '$dialog.find(".dynamicsprices-modal-input").css({"max-width":"40px","width":"40px"});';
