...
class ActionsDynamicsPrices extends CommonHookActions
{
	...
	public function formConfirm($parameters, &$object, &$action, $hookmanager)
	{
		...
		foreach ($displayDifferences as $lineId => $diff) {
			...
			$html .= '<td class="right"><input class="right width40" type="text" name="dynamicsprices_data['.$lineId.'][qty]" value="'.dol_escape_htmltag((string) $diff['qty']).'"></td>';
			$html .= '<td class="right"><input class="right width40" type="text" name="dynamicsprices_data['.$lineId.'][unitquantity]" value="'.dol_escape_htmltag((string) $diff['unitquantity']).'"></td>';
			$html .= '<td class="right"><input class="right width40" type="text" name="dynamicsprices_data['.$lineId.'][vat]" value="'.dol_escape_htmltag((string) $diff['vat']).'"></td>';
			$html .= '<td class="right">'.dol_escape_htmltag((string) $diff['current_unitprice']).'</td>';
			$html .= '<td class="right"><input class="right width40" type="text" name="dynamicsprices_data['.$lineId.'][unitprice]" value="'.dol_escape_htmltag((string) $diff['new_unitprice']).'"></td>';
			...
			$html .= '<td class="right"><input class="right width40" type="text" name="dynamicsprices_data['.$lineId.'][discount]" value="'.dol_escape_htmltag((string) $diff['discount']).'" placeholder="%"></td>';
